...
try:
    ...
    resources = [
                ...
                #auth_user specifically excluded
                "don_collect",
                "don_distribute",
                "don_don_item",
                "event_event",
                ...
                "org_organisation",
                "org_sector",
                "pr_person", # includes components: hrm_human_resource, pr_contact, pr_address
                "req_req",   # includes components: req_req_skill, req_req_item, vol_application, vol_assignment
            ]
else:
