...
$(document).ready(function() {
    ...
    if ( contains(S3.i18n.language, 'de', 'es', 'ja', 'ko', 'tl', 'vn', 'zh_TW') ) {
        // Language is supported - load file from static
        var oLanguage = { 'sUrl': S3.Ap.concat('/static/scripts/S3/i18n/jquery.dataTables.' + S3.i18n.language + '.js')
                        }
    } else {
        // Language is not supported - use default
        var oLanguage = { 'oPaginate': {
                                    'sFirst': '',
        							'sLast': '',
            						'sNext': '',
                					'sPrevious': ''
        ...
        'fnRowCallback': function( nRow, aData, iDisplayIndex ) {
            ...
            if (S3.dataTables.Actions) {
                ...
                for (i=0; i < Actions.length; i++) {
                    ...
                    ButtonsLength += 14 + 8*label.length
                }
                //Still broken in IE7
                Buttons = '<div style="width:' + ButtonsLength + 'px;">' + Buttons + "</div>"
