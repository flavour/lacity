(function(c){c.extend(c.fn,{pstrength:function(a){a=c.extend({verdects:[S3.i18n.very_weak,S3.i18n.weak,S3.i18n.medium,S3.i18n.strong,S3.i18n.very_strong,S3.i18n.too_short,S3.i18n.unsafe_password],colors:["#f00","#c06","#f60","#3c0","#3f0","#ccc","#f00"],scores:[10,15,30,40],common:["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey"],minchar:6,minchar_label:S3.i18n.password_chars},a);return this.each(function(){var e=c(this).attr("id");c(this).after('<div class="pstrength-minchar" id="'+e+'_minchar">'+
