 ...
 * 
 * === Changelog ===
 * Sahana Eden (22/09/2011) F. Boon
 *  i18n of the main text
...
(function($){
	$.extend($.fn, {
		pstrength : function(options) {
			var options = $.extend({
				verdects:	[S3.i18n.very_weak,S3.i18n.weak,S3.i18n.medium,S3.i18n.strong,S3.i18n.very_strong,S3.i18n.too_short,S3.i18n.unsafe_password],
				colors: 	["#f00","#c06", "#f60","#3c0","#3f0","#ccc","#f00"],
				scores: 	[10,15,30,40],
				common:		["password","sex","god","123456","123","liverpool","letmein","qwerty","monkey"],
				minchar:	6,
				minchar_label: S3.i18n.password_chars
			}, options);
