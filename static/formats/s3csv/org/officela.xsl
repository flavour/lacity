...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         ...
         building name...........org_office.building_name
         street address..........org_office.address
         post code...............org_office.postcode
         state...................org_office.L1
         county..................org_office.L2
         city....................org_office.L3
    ...
    <xsl:template match="/">
        <s3xml>
            ...
            <xsl:for-each select="table/row">
                ...
                <xsl:variable name="l2" select="col[@field='county']/text()"/>
                ...
                <resource name="org_office">
                    ...
                    <data field="L3"><xsl:value-of select="col[@field='city']"/></data>
