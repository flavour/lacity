...
<xsl:stylesheet
    ...
    <!-- **********************************************************************
         ...
         Incident.......................event_incident.name, & req_req.incident_id
         ...
         Date Required Until............req_req.date_required_until
         ...
         Published to Public............req_req.public
         @ToDo: Published to Organisations.....req_req.organisations_id
         Security Required..............req_req.security_req
    ...
    <xsl:template match="/">
        <s3xml>
            ...
            <!-- ********************************************************** -->
                ...
                <!-- Incident -->
                <xsl:variable name="Incident"><xsl:value-of select="col[@field='Incident']"/></xsl:variable>
                ...
                <resource name="req_req">
                    ...
                    <xsl:if test="col[@field='Request Type']='Inventory Items'">
                        <data field="type">1</data>
                    </xsl:if>
                    <xsl:if test="col[@field='Request Type']='Volunteer'">
                    ...
                    <data field="date_required_until"><xsl:value-of select="col[@field='Date Required Until']"/></data>
                    ...
                    <data field="public"><xsl:value-of select="col[@field='Public']"/></data>
