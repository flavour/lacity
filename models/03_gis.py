...
s3.gis_location_represent = gis_location_represent

def shn_gis_level_represent(level):
    if not level:
        return NONE
    elif level == "L0":
        return T("Country")
...
table = define_table(tablename,
                     ...
                     Field("level", length=2, label = T("Level"),
                           represent = shn_gis_level_represent),
...
# =============================================================================
def gis_config_tables():
    """
        Load the GIS Config Tables when needed
    """

    if "gis_config" in db.tables:
        return
...
def gis_map_tables():
    """
        ...
        NB Not needed at all for Give2LA
    """

    load("gis_config")
    marker_id = s3.marker_id
    projection_id = s3.projection_id
    symbology_id = s3.symbology_id
    ...
    table = define_table(tablename,
                         ...
                         Field("popup_label",        # @ToDo: Replace with crud_strings[tablename]?
                               label = T("Popup Label"),
                               comment=DIV( _class="tooltip",
    ...
    # Bing
    table = define_table("gis_layer_bing",
                         name_field(),
                         Field("description"),
    ...
    configure("gis_layer_bing",
                    onvalidation=gis_bing_onvalidation)

    # -------------------------------------------------------------------------
    # Coordinate
    table = define_table("gis_layer_coordinate",
                         name_field(),
                         Field("description", label=T("Description")),
    ...
    # -------------------------------------------------------------------------
    # GeoJSON
    table = define_table("gis_layer_geojson",
                         name_field(),
                         Field("description", label=T("Description")),
                         Field("enabled", "boolean", default=True, label=T("Available in Viewer?")),
                         Field("visible", "boolean", default=True,
    ...
    # -------------------------------------------------------------------------
    # GeoRSS
    table = define_table("gis_layer_georss",
                         name_field(),
                         Field("description", label=T("Description")),
                         Field("enabled", "boolean", default=True, label=T("Available in Viewer?")),
                         Field("visible", "boolean", default=True,
    ...
    # -------------------------------------------------------------------------
    # Google
    table = define_table("gis_layer_google",
                         name_field(),
                         Field("description"),
                         Field("enabled", "boolean", default=False),
                         Field("apikey"),
