...
if has_module("doc"):
    ...
    def doc_tables():
        ...
        if settings.has_module("project"):
            load("project_project")
        project_id = s3.project_id
        ...
        table = define_table(tablename,
                                ...
                                person_id(label=T("Author"),
                                          comment = shn_person_comment(T("Author"), T("The Author of this Document (optional)"))),
        ...
        add_component(table, **joinby)

        # Documents as Component of Sites
        add_component(table, org_site=super_key(db.org_site))
